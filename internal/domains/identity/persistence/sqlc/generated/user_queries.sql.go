...
RETURNING id, hubspot_id, country_alpha2_code, gender, first_name, last_name, parent_id, phone, email, has_marketing_email_consent, has_sms_consent, created_at, updated_at, dob, is_archived, square_customer_id, stripe_customer_id, notes, deleted_at, scheduled_deletion_at, email_verified, email_verification_token, email_verification_token_expires_at, email_verified_at, suspended_at, suspension_reason, suspended_by, suspension_expires_at
`
...
WITH u
         as (SELECT id, hubspot_id, country_alpha2_code, gender, first_name, last_name, parent_id, phone, email, has_marketing_email_consent, has_sms_consent, created_at, updated_at, dob, is_archived, square_customer_id, stripe_customer_id, notes, deleted_at, scheduled_deletion_at, email_verified, email_verification_token, email_verification_token_expires_at, email_verified_at, suspended_at, suspension_reason, suspended_by, suspension_expires_at
             FROM users.users u2
