package barber_event

import (
	dto "api/internal/domains/barber/dto"
	repository "api/internal/domains/barber/persistence/repository/event"
...
type EventsHandler struct {
	Repo repository.BarberEventsRepositoryInterface
}

func NewEventsHandler(repo repository.BarberEventsRepositoryInterface) *EventsHandler {
...
// @Success 200 {array} barber.ResponseDto "List of barber events retrieved successfully"
// @Failure 400 {object} map[string]interface{} "Bad Request: Invalid input"
// @Failure 500 {object} map[string]interface{} "Internal Server Error"
// @Router /barbers/events [get]
...
// @Success 201 {object} barber.ResponseDto "Barber event created successfully"
// @Failure 400 {object} map[string]interface{} "Bad Request: Invalid input"
// @Failure 500 {object} map[string]interface{} "Internal Server Error"
// @Router /barbers/events [post]
...
// @Success 200 {object} barber.ResponseDto "Barber event updated successfully"
// @Failure 400 {object} map[string]interface{} "Bad Request: Invalid input"
// @Failure 404 {object} map[string]interface{} "Not Found: Barber event not found"
// @Failure 500 {object} map[string]interface{} "Internal Server Error"
// @Router /barbers/events/{id} [put]
...
// @Failure 404 {object} map[string]interface{} "Not Found: Barber event not found"
// @Failure 500 {object} map[string]interface{} "Internal Server Error"
// @Router /barbers/events/{id} [delete]
...
// @Produce json
// @Param id path string true "Barber event ID"
// @Success 200 {object} barber.ResponseDto "Barber event details retrieved successfully"
// @Failure 400 {object} map[string]interface{} "Bad Request: Invalid ID"
// @Failure 404 {object} map[string]interface{} "Not Found: Barber event not found"
// @Failure 500 {object} map[string]interface{} "Internal Server Error"
// @Router /barbers/events/{id}/details [get]
