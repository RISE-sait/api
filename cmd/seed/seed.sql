...
-- Insert courses
INSERT INTO courses (id, name, description, start_date, end_date, created_at, updated_at, capacity) VALUES
  (gen_random_uuid(), 'Beginner Yoga', 'Introduction to yoga for all ages.', '2025-03-01 08:00:00+00', '2025-06-01 08:00:00+00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 150),
  (gen_random_uuid(), 'Advanced Swimming', 'For experienced swimmers looking to improve.', '2025-04-10 09:30:00+00', '2025-08-10 09:30:00+00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 200),
  (gen_random_uuid(), 'Basketball Training', 'Intensive training for basketball players.', '2025-05-15 17:00:00+00', '2025-09-15 17:00:00+00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 230),
  (gen_random_uuid(), 'Tennis for Beginners', 'Learn tennis from scratch with professional coaches.', '2025-06-20 10:00:00+00', '2025-10-20 10:00:00+00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 50),
  (gen_random_uuid(), 'Strength Training', 'Weightlifting and strength-building exercises.', '2025-07-05 12:00:00+00', '2025-11-05 12:00:00+00', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 100);
...
INSERT INTO customer_events (customer_id, event_id, checkedinat) VALUES
...
INSERT INTO customer_events (customer_id, event_id, checkedinat) 
VALUES 
...
INSERT INTO customer_memberships (customer_id, membership_id, start_date, renewal_date, status)
