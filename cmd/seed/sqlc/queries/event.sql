...
WITH events_data AS (SELECT unnest(@recurring_start_at_array::timestamptz[]) as recurrence_start_at,
                            unnest(@recurring_end_at_array::timestamptz[])   as recurrence_end_at,
...
INSERT
INTO events.events (recurrence_start_at, recurrence_end_at, event_start_time, event_end_time, program_id, day,
                    location_id)
