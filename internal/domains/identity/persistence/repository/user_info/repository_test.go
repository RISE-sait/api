...
func SetupUserInfoTempRepo(t *testing.T) (*user.Repository, *InfoTempRepo) {
	...
	return user.NewUserRepository(queries), NewInfoTempRepository(queries)
}
...
func TestCreateTempUserInfoTx(t *testing.T) {
	...
	err = tempUserInfoRepo.CreateTempUserInfoTx(context.Background(), nil, *userId, firstName, lastName, &email, &parentHubspotId, age)
	...
	retrievedUser, err := tempUserInfoRepo.GetTempUserInfoByEmail(context.Background(), email)
...
func TestDeleteTempUserInfoTx(t *testing.T) {
	...
	err = tempUserInfoRepo.CreateTempUserInfoTx(context.Background(), nil, *userId, firstName, lastName, &email, nil, age)
	...
	err = tempUserInfoRepo.DeleteTempUserInfoTx(context.Background(), nil, *userId)
	...
	_, err = tempUserInfoRepo.GetTempUserInfoByEmail(context.Background(), email)
...
func TestGetTempUserInfoByEmail_NotFound(t *testing.T) {
	...
	_, err := tempUserInfoRepo.GetTempUserInfoByEmail(context.Background(), "nonexistent@example.com")
