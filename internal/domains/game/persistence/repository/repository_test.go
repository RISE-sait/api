...
//
//	return NewGameRepository(queries)
//}
//
...
//		ID:          course2.ID,  // Same HubSpotId as the first course
//		Name:        "Go Course", // Duplicate name
