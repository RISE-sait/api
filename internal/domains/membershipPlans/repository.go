...
func (r *Repository) CreateMembershipPlan(c context.Context, membershipPlan *db.CreateMembershipPlanParams) *types.HTTPError {
...
func (r *Repository) GetMembershipPlanDetails(c context.Context, membershipId uuid.UUID, planId uuid.UUID) (*[]db.MembershipPlan, *types.HTTPError) {
...
func (r *Repository) UpdateMembershipPlan(c context.Context, plan *db.UpdateMembershipPlanParams) *types.HTTPError {
...
func (r *Repository) DeleteMembershipPlan(c context.Context, plan *db.DeleteMembershipPlanParams) *types.HTTPError {
